...
description: Review a Lily PLAN.md before execution. Use to check scope, requirements alignment, acceptance criteria, verification, risks, and stale assumptions.
---
