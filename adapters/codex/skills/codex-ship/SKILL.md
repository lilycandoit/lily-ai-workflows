---
name: codex-ship
description: Publish completed work using Lily AI workflows. Use only when explicitly asked to push, publish, create a PR, tag, release, or ship.
---
...
`~/.codex/custom-workflows/ship.md`
