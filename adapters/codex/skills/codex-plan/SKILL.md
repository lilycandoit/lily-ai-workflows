---
name: codex-plan
description: Create one focused implementation plan using Lily AI workflows. Use when planning current phase work, creating a PLAN.md, or turning roadmap goals into executable steps.
---
