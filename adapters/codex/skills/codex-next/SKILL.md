---
name: codex-next
description: Move from a completed phase to the next phase using Lily AI workflows, ROADMAP.md, STATE.md, and .planning files. Use when a phase is complete and planning should advance.
---
